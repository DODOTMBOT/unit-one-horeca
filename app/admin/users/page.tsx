      ...
      <div className="mx-auto max-w-[1200px] px-6 pt-10">
        ...
        <header className="sticky top-6 z-40 mb-12 flex h-20 items-center justify-between rounded-full border border-white bg-white/70 px-8 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.04)]">
          <div className="flex items-center gap-6">
            ...
            >
              <ChevronLeft size={20} className="text-slate-600 group-hover:text-violet-600" />
            </Link>
            <div>
              <h1 className="text-lg font-black uppercase tracking-tighter text-[#1e1b4b]">Управление доступом</h1>
              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Пользователи и роли</p>
            </div>
          </div>
          
          <div className="hidden md:flex items-center gap-3 px-4 py-2 rounded-full bg-slate-50 border border-slate-100">
            <div className="h-2 w-2 rounded-full bg-violet-500 animate-pulse" />
            <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">Безопасность OK</span>
          </div>
        </header>
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          ...
          {/* Блок 1: Список пользователей - ФИОЛЕТОВЫЙ */}
          <Link 
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="mt-2 h-1.5 w-12 rounded-full bg-violet-500 transition-all group-hover:w-20" />
              <p className="mt-4 text-[11px] font-bold leading-relaxed text-slate-400 uppercase tracking-widest">
                Управление аккаунтами сервиса и правами доступа
              </p>
            </div>
          </Link>
